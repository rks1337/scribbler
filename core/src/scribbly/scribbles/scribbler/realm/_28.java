...
public class _28 implements Screen {
	...
	public void show() {
		...
		//platform
		ground = new Polygon(1, 1f, new Vector2(0, -3), 3);
		...
		//dot
		Particle dot = new Particle(0, -4, 1, 2);
