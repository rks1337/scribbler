...
public class _10 implements Screen {
	...
	public void show() {
		...
		//platform1
		ground = new Polygon(15, 1, new Vector2(10, 3), 1);
		...
		//platform2
		ground = new Polygon(15, 1, new Vector2(-22, 3), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		body = world.createBody(ground.bodyDef);
		...
		//dot
		Particle dot = new Particle(12, 5, 1, 1);
