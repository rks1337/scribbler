...
public class _29 implements Screen {
	...
	public void show() {
			...
			public boolean touchDown(float x, float y, int pointer, int button) {
				if (complete && fade == 0.5f) {
					...
					if (take_screenshot) {
						...
						//reset
						((Game) Gdx.app.getApplicationListener()).setScreen(new _29());
					}
				}
		...
		//base line 1
		//plat base
		ground = new Polygon(1, 1f, new Vector2(-7, 6), 1);
		...
		//mid1
		ground = new Polygon(1, 1f, new Vector2(-3.5f, 3.25f), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		ground.bodyDef.angularVelocity = -2f;
		ground.bodyDef.type = BodyType.KinematicBody;
		body = world.createBody(ground.bodyDef);
		body.createFixture(ground.fixtureDef).setUserData(ground.polygon_sprite);
		ground.polygon_shape.dispose();

		ground = new Polygon(1, 1f, new Vector2(0, 6), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		ground.bodyDef.angularVelocity = 2f;
		...
		//mid3
		ground = new Polygon(1, 1f, new Vector2(10.5f, 3.25f), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		ground.bodyDef.angularVelocity = -2f;
		...
		//base line 2
		ground = new Polygon(1, 1f, new Vector2(0, -.25f), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		ground.bodyDef.angularVelocity = 2f;
		...
		//mid
		ground = new Polygon(1, 1f, new Vector2(3.5f, -3.5f), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		ground.bodyDef.angularVelocity = 2f;
		...
		ground = new Polygon(1, 1f, new Vector2(7, 0f), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		ground.bodyDef.angularVelocity = 2f;
		...
		//base line 3
		ground = new Polygon(1, 1f, new Vector2(7, -8), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		ground.bodyDef.type = BodyType.KinematicBody;
		...
		body.createFixture(ground.fixtureDef).setUserData(ground.polygon_sprite);
		ground.polygon_shape.dispose();
		ground = new Polygon(1, 1f, new Vector2(14, -8), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		ground.bodyDef.type = BodyType.KinematicBody;
