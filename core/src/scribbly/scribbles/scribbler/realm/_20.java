...
public class _20 implements Screen {
	...
	public void show() {
		...
		//platform
		ground = new Polygon(5, .1f, new Vector2(-8, 5), 1);
		...
		//platform2
		ground = new Polygon(5, .1f, new Vector2(5, 1), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		body = world.createBody(ground.bodyDef);
		...
		//platform3
		ground = new Polygon(5, .1f, new Vector2(-8, -3), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		body = world.createBody(ground.bodyDef);
