...
public class _14 implements Screen {
	...
	public void show() {
		...
		//ground1
		ground = new Polygon(10, .1f, new Vector2(10, 6), 1);
		...
		//ground2
		ground = new Polygon(10, .1f, new Vector2(-4, 0), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		body = world.createBody(ground.bodyDef);
		...
		//dot
		Particle dot = new Particle(10, 8, 1, 1);
