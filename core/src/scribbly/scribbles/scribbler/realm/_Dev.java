...
public class _Dev implements Screen {
	...
	public void show() {
		...
		//platform
		ground = new Polygon(3, .1f, new Vector2(-7, 1), 1);
		...
		//dot
		Particle dot = new Particle(-7, 6, 1, 1);
	...
	public void render(float delta) {
		...
		for (Body body : bodies_to_render) {
			if (body.getUserData() instanceof Sprite) {
				...
				//remove goo particles that are off screen
