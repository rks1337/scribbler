...
public class _30 implements Screen {
	...
	public void show() {
			...
			public boolean touchDown(float x, float y, int pointer, int button) {
				if (complete && fade == 0.5f) {
					...
					if (take_screenshot) {
						...
						//next
						((Game) Gdx.app.getApplicationListener()).setScreen(new _31());
					} else {
						//reset
						((Game) Gdx.app.getApplicationListener()).setScreen(new _30());
					}
				}
		...
		//base
		ground = new Polygon(1, 1f, new Vector2(-9, -7), 1);
		...
		//platform1
		ground = new Polygon(1, 1f, new Vector2(4, -7), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		body = world.createBody(ground.bodyDef);
		...
		//shifting platform
		ground = new Polygon(1, 1f, new Vector2(7, -9), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		...
		//platform3
		ground = new Polygon(1, 1f, new Vector2(10, -7), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		body = world.createBody(ground.bodyDef);
		...
		//platform4
		ground = new Polygon(1, 1f, new Vector2(13, -7), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		body = world.createBody(ground.bodyDef);
		...
		//platform5
		ground = new Polygon(1, 1f, new Vector2(16, -7), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		...
		//platform6
		ground = new Polygon(1, 1f, new Vector2(19, -7), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4;
		body = world.createBody(ground.bodyDef);
		...
		//wall
		ground = new Polygon(1, 1, new Vector2(0, 7), 3);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		...
		ground = new Polygon(1, 1, new Vector2(0, 4), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4;
		body = world.createBody(ground.bodyDef);
		...
		ground = new Polygon(1, 1, new Vector2(0, 1), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4;
		body = world.createBody(ground.bodyDef);
		...
		ground = new Polygon(1, 1, new Vector2(0, -2), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4;
		body = world.createBody(ground.bodyDef);
		...
		ground = new Polygon(1, 1, new Vector2(0, -5), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4;
		body = world.createBody(ground.bodyDef);
		...
		ground = new Polygon(1, 1, new Vector2(0, -8), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4;
		body = world.createBody(ground.bodyDef);
		...
		ground = new Polygon(1, 1, new Vector2(0, -11), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4;
		body = world.createBody(ground.bodyDef);
		...
		//dot
		Particle dot = new Particle(7, -4, 1, 1);
		...
		//cup
		ground = new Polygon(1.75f, .1f, new Vector2(-9, -6), 0);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		ground.bodyDef.type = BodyType.KinematicBody;
		...
		ground = new Polygon(.1f, 2f, new Vector2(-11, -4), 0);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		...
		ground = new Polygon(.1f, 2f, new Vector2(-7, -4), 0);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		ground.bodyDef.angle = -.1f;
	...
	public void render(float delta) {
		...
		System.out.println(stop_kinematics);
		...
		if (!stop_kinematics) {
			...
			//shifting platform
			if (move_up) {
				if (shifting_platform.getPosition().y < 9) {
					shifting_platform.setLinearVelocity(new Vector2(0, 5));
				}
				if (shifting_platform.getPosition().y > 9) {
					move_up = false;
					move_down = true;
