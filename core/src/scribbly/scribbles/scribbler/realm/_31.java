...
public class _31 implements Screen {
	...
	public void show() {
			...
			public boolean touchDown(float x, float y, int pointer, int button) {
				if (complete && fade == 0.5f) {
					...
					if (take_screenshot) {
						...
						//next
						((Game) Gdx.app.getApplicationListener()).setScreen(new _32());
					} else {
						//reset
		...
		//platform-1
		ground = new Polygon(1, 1f, new Vector2(-6, 0), 1);
		...
		//base
		ground = new Polygon(1, 1f, new Vector2(9, 4), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		body = world.createBody(ground.bodyDef);
		...
		//dot
		Particle dot = new Particle(9, 6, 1, 1);
		...
		//spindle1
		ground = new Polygon(5, .1f, new Vector2(0, 5), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4;
		ground.bodyDef.type = BodyType.KinematicBody;
		...
		ground = new Polygon(.1f, 5f, new Vector2(0, 5), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4;
		ground.bodyDef.type = BodyType.KinematicBody;
		...
		//cup
		ground = new Polygon(1.75f, .1f, new Vector2(7, -11), 0);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		ground.bodyDef.type = BodyType.KinematicBody;
		...
		ground.polygon_shape.dispose();
		//-2, -2
		ground = new Polygon(.1f, 2f, new Vector2(5, -9), 0);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		...
		ground.polygon_shape.dispose();
		//+4, 0
		ground = new Polygon(.1f, 2f, new Vector2(9, -9), 0);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		ground.bodyDef.angle = -.1f;
		...
		ground = new Polygon(1, 1f, new Vector2(7, -12), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = -4f;
		body = world.createBody(ground.bodyDef);
