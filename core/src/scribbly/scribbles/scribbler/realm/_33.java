...
public class _33 implements Screen {
	...
	public void show() {
		...
		//cup
		ground = new Polygon(1.75f, .1f, new Vector2(-8, -12), 0);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		...
		ground.polygon_shape.dispose();
		//-2, -2
		ground = new Polygon(.1f, 2f, new Vector2(-10, -10), 0);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = 2.256f;
		...
		ground.polygon_shape.dispose();
		//+4, 0
		ground = new Polygon(.1f, 2f, new Vector2(-6, -10), 0);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = 2.256f;
		ground.bodyDef.angle = -.1f;
		...
		ground = new Polygon(2, 1, new Vector2(-8, -13), 1);
		ground.fixtureDef.filter.categoryBits = 4; //is a
		ground.fixtureDef.filter.maskBits = 1 | 2 | 4; //collides with
		ground.bodyDef.gravityScale = 2.256f;
		ground.bodyDef.type = BodyType.KinematicBody;
